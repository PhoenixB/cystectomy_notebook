...
tibble(
  ...
  z_bmi = seq(from = -1, to = 2, length.out = 13), # c(10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60),
  cci = "0",
  gender = "male",
  p_tumor = "0",
  p_nodes = "0"
...
labs(title = str_wrap("Distribution of blood loss ratio depending on standardized body mass index", 100), subtitle = str_wrap("Other variables held at reference level or median", 100), x = "Blood loss ratio", y = "Count", colour = str_wrap("Body mass index (standard deviations)", 20)) +
