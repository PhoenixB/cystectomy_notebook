...
model1 <- tab_model(model.intraoptransfusion_bloodlosspercent_preophb_opyear, rm.terms = c("Intercept"), pred.labels = c(blood_loss_percent = "Percent blood loss", preop_hb = "Preoperative hemoglobin"), dv.labels = c("Intraoperative transfusion"), show.ci = 0.999, use.viewer = FALSE)
cat(model1$knitr)
```
...
pp_check(model.intraoptransfusion_bloodlosspercent_preophb_opyear)
