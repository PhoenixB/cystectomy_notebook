...
tab_model(
  models.intraoptransfusion_multivar[[1]],
...
pp_check(models.intraoptransfusion_multivar[[1]], nsamples = 10)
```
...
tab_model(
  models.intraoptransfusion_multivar[[2]],
  rm.terms = c("Intercept"),
  pred.labels = c(
    blood_loss_percent = "Percent blood loss",
    preop_hb = "Preoperative hemoglobin"
...
pp_check(models.intraoptransfusion_multivar[[2]], nsamples = 10)
```
