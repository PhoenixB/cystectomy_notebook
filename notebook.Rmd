...
table.model2 <- tab_model(model.bloodlossratio_oak_tcaggr_bmi_cci_gender_ptumor_pnodes_opyear, pred.labels = c(oakTRUE = "Oral anticoagulation", tcaggrTRUE = "Thrombocyte aggregation inhibition", bmi = "Body mass index", genderfemale = "Female gender", cci = "Charleston comorbidity index", p_tumor = "Tumor stadium", p_nodes = "Nodal stadium"), dv.labels = c("Blood loss ratio"), show.ci = 0.95, rm.terms = c("cci1", "p_tumor1", "p_nodes1"), use.viewer = FALSE)
...
labs(title = str_wrap("Distribution of blood loss ratio depending on bmi", 100), subtitle = str_wrap("Other variables held at zero", 100), x = "Blood loss ratio", y = "Count", colour = "Body mass index") +
