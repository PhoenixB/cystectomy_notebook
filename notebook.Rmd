...
labs(title = str_wrap("Distribution of blood loss ratio depending on body mass index", 100), subtitle = str_wrap("Other variables held at reference level or median", 100), x = "Blood loss ratio", y = "Count", colour = str_wrap("Body mass index", 20)) +
