...
tibble(
  ...
  tcaggr = FALSE,
  m_age = 0,
  m_bmi = seq(from = -1, to = 3, length.out = 9),
  cci = "0",
  gender = "male",
  p_tumor = "0",
  p_nodes = "0"
...
ggplot(aes(x = .prediction, colour = factor(2 * m_bmi))) +
geom_freqpoly(binwidth = 0.05) +
labs(title = str_wrap("Distribution of blood loss ratio depending on standardized body mass index", 100), subtitle = str_wrap("Other variables held at reference level or median", 100), x = "Blood loss ratio", y = "Count", colour = str_wrap("Body mass index (median absolute deviations)", 20)) +
